...
class __TwigTemplate_6b81ae9487709476fb929abe7bd7cb59d71e3918656de08818b9d7e8e348a542 extends \Twig\Template
{
    ...
    <h1>Bonjour ";
        ...
        echo " !</h1>
    <p>Voici votre profil wemoovies. Alimentez-le pour qu'il vous ressemble !</p>
    <div class=\"navProfil\">
        ";
        // line 11
        echo "        <div>
            <button type=\"button\" class=\"\">Informations</button>
            <div class=\"\" id=\"myInformations\">
                <div>
                    <p>Votre pseudo : ";
        // line 15
        ...
        echo " </p>
                    <p>Votre role : ";
        // line 17
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 17, $this->source); })()), "user", [], "any", false, false, false, 17), "roles", [], "any", false, false, false, 17), 0, [], "array", false, false, false, 17), "html", null, true);
        echo " </p>
                </div>
                <div>
        ...
        // line 26
        echo "        <div>
            <button type=\"button\" class=\"\">Favoris</button>
            <div>
            </div>
        </div>
    </div>
...
";
    ...
    {
        return array (  150 => 35,  140 => 34,  123 => 26,  112 => 17,  108 => 16,  104 => 15,  98 => 11,  92 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
        ...
        <div>
            ...
            <div class=\"\" id=\"myInformations\">
                <div>
                    ...
                    <p>Votre adresse email : {{ app.user.email }} </p>
                    <p>Votre role : {{ app.user.roles[0] }} </p>
                </div>
                <div>
                    <a href=\"#\">Editer mes informations</a>
                    <a href=\"#\">Supprimer mon compte</a>
